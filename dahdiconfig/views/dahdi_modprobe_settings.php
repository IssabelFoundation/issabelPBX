<div class="modal animate__animated animate__fadeIn" id="modprobesettings">
  ...
  <div class="modal-card">
    <header class="modal-card-head">
      <p class="modal-card-title" style="margin-bottom:0;"><?php echo _('Modprobe Settings')?></p>
    ...
    <section class="modal-card-body">
        <form id="form-modprobe" action="config.php?quietmode=1&amp;handler=file&amp;module=dahdiconfig&amp;file=ajax.html.php&amp;type=modprobesubmit">
            <div class='columns'>
                <div class='column'>
                    <a href="#" class="info"><?php echo _('Module Name')?><span><?php echo _('Specify the kernel module used by the installed analog hardware')?>.</span></a>
                </div>
                <div class='column'>
            ...
            <div class='columns' id="wctc4xxp_settings">
                <div class='column'>
                    <a href="#" class="info"><?php echo _('Mode')?><span><?php echo _('In Any mode it\'ll run 92 channels of either codec.')?><br/><?php echo _('In G.729 mode it\'ll run 120 channels')?>'<br/><?php echo _('In G.723.1 mode it\'ll run 92 channels')?>.</span></a>
                </div>
                <div class='column'>
            ...
            <div class='columns'>
                <div class='column'>
                    <a href="#" class="info"><?php echo _('FXS Honor Mode')?><span><?php echo _('Specify whether to apply the opermode setting to your FXO modules only, or to both FXS and FXO modules. If no choice is specified, the default is apply opermode to fxo modules only')?>.</span></a>
                </div>
                <div class='column'>
            ...
            <div class='columns'>
                <div class='column'>
                    <a href="#" class="info"><?php echo _('Boostringer')?><span><?php echo _('Specify the voltage used for ringing an analog phone. Normal will set the ring voltage to 40V, and Peak will set the voltage to 89V. If no choice is specified, the default is normal')?>.</span></a>
                </div>
                <div class='column'>
            ...
            <div class='columns'>
                <div class='column'>
                    <a href="#" class="info"><?php echo _('Fastringer:')?><span><?php echo _('Specify whether to apply Fast Ringer operation. Setting Fast Ringer (25Hz) (commonly used in conjunction with the Low Power option) increases the ringing speed to 25Hz. If no choice is specified, the default is normal')?>.</span></a>
                </div>
                <div class='column'>
            ...
            <div class='columns'>
                <div class='column'>
                    <a href="#" class="info"><?php echo _('Lowpower')?><span><?php echo _('Specify whether to apply Low Power operation. Setting Fast Ringer to 50V peak in conjunction with the Fast Ringer option increases the peak voltage during Fast Ringer operation to 50V. If no choice is specified, the default is normal')?>.</span></a>
                </div>
                <div class='column'>
            ...
            <div class='columns'>
                <div class='column'>
                    <a href="#" class="info"><?php echo _('MWI Mode')?><span><?php echo _('Specify the type of Message Waiting Indicator detection to be done on FXO ports. If no choice is specified, the default is none. The following options are available')?>:
                	<ul>
            ...
            <div class='columns' id="vpmsettings">
                <div class='column'>
                    <a href="#" class="info"><?php echo _('Echo Canc. NLP Type')?><span> <?php echo _('This option allows you to specify the type of Non Linear Processor you want applied to the post echo-cancelled audio reflections received from analog connections (VPMADT032 only). There are several options')?>:
            		<ul>
            ...
            <div class='columns'>
                <div class='column'>
                    <a href="#" class="info"><?php echo _('Echo Canc. NLP Threshold')?><span><?php echo _('This option allows you to specify the threshold, in dB difference between the received audio (post echo cancellation) and the transmitted audio, for when the NLP will engage (VPMADT032 only). The default setting is 24 dB')?>.</span></a>
                </div>
                <div class='column'>
            ...
            <div class='columns'>
                <div class='column'>
                    <a href="#" class="info"><?php echo _('Echo Canc. NLP Max Suppression')?><span><?php _('This option, only functional when the Echo Cancellation NLP Type option is set to Suppression NLP, specifies the maximum amount of dB that the NLP should attenuate the residual echo (VPMADT032 only). Lower numbers mean that the NLP will provide less suppression (the residual echo will sound louder). Higher numbers, especially those approaching or equaling the Echo Cancellation NLP Threshold option, will nearly mute the residual echo. The default setting is 24 dB')?>.</span></a>
                </div>
                <div class='column'>
        ...
        ?>
            <div class='columns'>
                <div class='column'>
                    <?php echo _('Other Modprobe Settings')?>: 
                </div>
            </div>
            ...
            <div class='columns' id="mp_add">
                ...
                <div class='column'>
                    <a id="mp_add_button" style="cursor: pointer;" onclick="mp_add_field(<?php echo $a?>,'<?php echo $dahdi_cards->get_modprobe('module_name')?>')" class="button is-small is-rounded"><?php echo _('Add another field');?></a>
                </div>
            </div>
</form>
    </section>
