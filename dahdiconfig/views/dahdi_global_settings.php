...
<form id="form-globalsettings" action="config.php?quietmode=1&amp;handler=file&amp;module=dahdiconfig&amp;file=ajax.html.php&amp;type=globalsettingssubmit">
    <div class='columns mb-5'><div class='column'>
        <div class='is-size-7'><?php echo sprintf(_('This edits all settings in %s'),'chan_dahdi.conf')?></div>
    </div></div>

        <div class='columns'>
            <div class='column'>
                <a href="#" class="info"><?php echo _('Select Language')?><span><?php echo _('Specify the language') ?></span></a>
        ...
        <div class='columns'>
            <div class='column'>
                <a href="#" class="info"><?php echo _('Enable Busy Detect')?><span><?php echo _('On trunk interfaces (FXS) and E&M interfaces (E&M, Wink, Feature Group D etc) it can be useful to perform busy detection either in an effort to detect hangup or for detecting busies');?>.<br/><?php echo _('This enables listening for the beep-beep busy pattern')?>.</span></a>
        	</div>
        	<div class='column'>
        ...
        <div class='columns'>
           <div class='column'>
            	<a href="#" class="info"><?php echo _('Use Caller ID')?><span><?php echo _('Whether or not to use caller ID')?></span></a>
            </div>
            <div class='column'>
        ...
        <div class='columns'>
            <div class='column'>
                <a href="#" class="info"><?php echo _('Enable Call Waiting')?><span><?php echo _('Whether or not to enable call waiting on internal extensions. With this set to "yes", busy extensions will hear the call-waiting tone, and can use hook-flash to switch between callers. The Dial() app will not return the "BUSY" result for extensions.')?></span></a>
            </div>
            <div class='column'>
        ...
        <div class='columns'>
            <div class='column'>
                <a href="#" class="info"><?php echo _('Use Caller ID Presentation')?><span><?php echo _('Whether or not to use the caller ID presentation for the outgoing call that the calling switch is sending')?>.</span></a>
            </div>
            <div class='column'>
        ...
        <div class='columns'>
            <div class='column'>
                <a href="#" class="info"><?php echo _('Enable Three Way Calling')?><span><?php echo _('Support three-way calling')?></span></a>
            </div>
            <div class='column'>
        ...
        <div class='columns'>
            <div class='column'>
                <a href="#" class="info"><?php echo _('Enable Transfer')?><span><strong><?php echo _('For FXS ports (either direct analog or over T1/E1)')?></strong><br/>
                    ...
                    <?php echo _('This setting must be enabled on both ports involved, and the "facilityenable" setting must also be enabled to allow sending the transfer to the ISDN switch, since it sent in a FACILITY message')?>.</span></a>
            </div>
            <div class='column'>
        ...
        <div class='columns'>
            <div class='column'>
                <a href="#" class="info"><?php echo _('Enable Call Forwarding')?><span><?php echo _('Support call forward variable')?></span></a>
            </div>
            <div class='column'>
        ...
        <div class='columns'>
            <div class='column'>
                <a href="#" class="info"><?php echo _('Enable Call Return')?><span><?php echo _('Whether or not to support Call Return (*69, if your dialplan doesn\'t catch this first)')?></span></a>
            </div>
            <div class='column'>
        ...
        <div class='columns'>
            <div class='column'>
                <a href="#" class="info"><?php echo _('Enable Echo Canceling')?><span><?php echo _('Enable echo cancellation')?><br/>
        ...
        <div class='columns'>
            <div class='column'>
                <a href="#" class="info"><?php echo _('Enable EC when bridged')?><span><?php echo _('Generally, it is not necessary (and in fact undesirable) to echo cancel when the circuit path is entirely TDM.  You may, however, change this behavior by enabling the echo canceler during pure TDM bridging below')?>.</span></a>
            </div>
            <div class='column'>
        ...
        <div class='columns'>
            <div class='column'>
                <a href="#" class="info"><?php echo _('Enable Echo Training')?><span><?php echo _('In some cases, the echo canceller doesn\'t train quickly enough and there is echo at the beginning of the call.  Enabling echo training will cause DAHDI to briefly mute the channel, send an impulse, and use the impulse response to pre-train the echo canceller so it can start out with a much closer idea of the actual echo.  Value may be "yes", "no", or a number of milliseconds to delay before training (default = 400)')?><br />
                <br/>
                ...
                <br/>
                <?php echo _('Note that these parameters do not apply to hardware echo cancellers')?>.</span></a>
            </div>
            <div class='column'>
        ...
        <div class='columns'>
            <div class='column'>
                <a href="#" class="info"><?php echo _('Answer Immediately')?><span><?php echo _('Specify whether the channel should be answered immediately or if the simple switch should provide dialtone, read digits, etc')?>.<br/>
                    <?php echo _('Note: If yes the dialplan execution will always start at extension \'s\' priority 1 regardless of the dialed number!')?></span></a>
            </div>
            <div class='column'>
        ...
        <div class='columns'>
            <div class='column'>
                <a href="#" class="info"><?php echo _('Fax Detection')?><span><?php echo _('For fax detection')?></span></a>
            </div>
            <div class='column'>
        ...
        <div class='columns'>
            <div class='column'> 
                <a href="#" class="info"><?php echo _('Receive Gain')?><span><?php echo _('The values are in db (decibels). A positive number increases the volume level on a channel, and a negative value decreases volume level')?>.</span></a>
            </div>
            <div class='column'>
        ...
        <div class='columns'>
            <div class='column'> 
                <a href="#" class="info"><?php echo _('Transmit Gain')?><span><?php echo _('The values are in db (decibels). A positive number increases the volume level on a channel, and a negative value decreases volume level')?>.</span></a>
            </div>
            <div class='column'>
    ...
    ?>
        <div class='columns' id="dh_global_additional_0">
            <div class='column'>
                <?php echo _('Other Global Dahdi Settings')?>
                <br/>
        ...
        <div class='columns' id="dh_global_add">
            <div class='column'>
                <a style="cursor: pointer;" onclick="dh_global_add_field(<?php echo $a?>)" class='button is-small is-rounded'><?php echo _("Add another field");?></a>
            </div>
        </div>
    </form>
    </section>
    <footer class="modal-card-foot">
      <button data-target="form-globalsettings" class="button is-success formsubmit"><?php echo _('Save')?></button>
