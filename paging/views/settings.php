...
$table->add_row(array('colspan' => 2, 'data' => heading(_('Auto-answer defaults'), 5) ));

$label = ipbx_label(_('Announcement'), _('Annoucement to be played to remote part. Default is a beep'));
