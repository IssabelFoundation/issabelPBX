// jsTree 1.0-rc3 http://jstree.com/  Copyright (c) 2010 Ivan Bozhanov (vakata.com) $Date: 2011-02-09 01:17:14 +0200 (ÑÑ€, 09 Ñ„ÐµÐ²Ñ€ 2011) Revision: 236
"use strict";
(function() {
        ...
        $.fn.jstree = function(settings) {
            ...
            if (isMethodCall) {
                ...
                this.each(function() {
                    ...
                    b.plugins = (b.plugins instanceof Array) ? b.plugins : $.jstree.defaults.plugins.slice();
        ...
        $.jstree.plugin("core", {
            ...
            _fn: {
                init: function() {
                    ...
                    this.get_container().on("click.jstree", "li > ins", $.proxy(function(event) {
                        var trgt = $(event.target);
                        this.toggle_node(trgt);
                    }, this)).on("mousedown.jstree", $.proxy(function() {
                        this.set_focus();
                    }, this)).on("dblclick.jstree", function(event) {
                        var sel;
                    ...
                    if (this._get_settings().core.notify_plugins) {
                        this.get_container().on("load_node.jstree", $.proxy(function(e, data) {
    ...
    (function($) {
        ...
        $.jstree.plugin("ui", {
            __init: function() {
                ...
                this.get_container().on("click.jstree", "a", $.proxy(function(event) {
                    event.preventDefault();
                    event.currentTarget.blur();
                    if (!$(event.currentTarget).hasClass("jstree-loading")) {
                        this.select_node(event.currentTarget, true, event);
                    }
                }, this)).on("mouseenter.jstree", "a", $.proxy(function(event) {
                    if (!$(event.currentTarget).hasClass("jstree-loading")) {
                        this.hover_node(event.target);
                    }
                }, this)).on("mouseleave.jstree", "a", $.proxy(function(event) {
                    if (!$(event.currentTarget).hasClass("jstree-loading")) {
                        this.dehover_node(event.target);
                    }
                }, this)).on("reopen.jstree", $.proxy(function() {
                    this.reselect();
                }, this)).on("get_rollback.jstree", $.proxy(function() {
                    this.dehover_node();
                    this.save_selected();
                }, this)).on("set_rollback.jstree", $.proxy(function() {
                    this.reselect();
                }, this)).on("close_node.jstree", $.proxy(function(event, data) {
                ...
                }, this)).on("delete_node.jstree", $.proxy(function(event, data) {
                ...
                }, this)).on("move_node.jstree", $.proxy(function(event, data) {
                    if (data.rslt.cy) {
    ...
    (function($) {
        $.jstree.plugin("crrm", {
            __init: function() {
                this.get_container().on("move_node.jstree", $.proxy(function(e, data) {
    ...
    (function($) {
        ...
        $.jstree.plugin("themes", {
            __init: function() {
                this.get_container().on("init.jstree", $.proxy(function() {
                    var s = this._get_settings().themes;
                    this.data.themes.dots = s.dots;
                    this.data.themes.icons = s.icons;
                    this.set_theme(s.theme, s.url);
                }, this)).on("loaded.jstree", $.proxy(function() {
            ...
            __init: function() {
                ...
                $.each(this._get_settings().hotkeys, function(i, v) {
                    if (v !== false && $.inArray(i, bound) == -1) {
                        $(document).on("keydown", i, function(event) {
                            return exec(i, event);
                        });
                        bound.push(i);
                    }
                });
                this.get_container().on("lock.jstree", $.proxy(function() {
                    if (this.data.hotkeys.enabled) {
                        this.data.hotkeys.enabled = false;
                        this.data.hotkeys.revert = true;
                    }
                }, this)).on("unlock.jstree", $.proxy(function() {
        ...
        $.jstree.plugin("json_data", {
            ...
            _fn: {
                    ...
                    switch (!0) {
                        ...
                        case (!s.data && !!s.ajax) || (!!s.data && !!s.ajax && obj && obj !== -1):
                            ...
                            success_func = function(d, t, x) {
                                ...
                                if (d === "" || (d && d.toString && d.toString().replace(/^[\s\n]+$/, "") === "") || (!(d instanceof Array) && !$.isPlainObject(d))) {
                    ...
                    if (js instanceof Array) {
                        ...
                        if (js.children) {
                            if (s.progressive_render && js.state !== "open") {
                                ...
                                if ((js.children instanceof Array) && js.children.length) {
                ...
                get_json: function(obj, li_attr, a_attr, is_callback) {
                    ...
                    li_attr = (li_attr instanceof Array) ? li_attr : ["id", "class"];
        ...
        $.jstree.plugin("cookies", {
            __init: function() {
                ...
                this.get_container().one((this.data.ui ? "reselect" : "reopen") + ".jstree", $.proxy(function() {
                    this.get_container().on("open_node.jstree close_node.jstree select_node.jstree deselect_node.jstree", $.proxy(function(e) {
        ...
        $.jstree.plugin("sort", {
            __init: function() {
                this.get_container().on("load_node.jstree", $.proxy(function(e, data) {
                    ...
                    this.sort(obj);
                }, this)).on("rename_node.jstree create_node.jstree create.jstree", $.proxy(function(e, data) {
    ...
    (function($) {
        ...
        $.jstree.plugin("dnd", {
            __init: function() {
                ...
                this.get_container().on("mouseenter.jstree", $.proxy(function(e) {
                ...
                }, this)).on("mouseup.jstree", $.proxy(function(e) {
                ...
                }, this)).on("mouseleave.jstree", $.proxy(function(e) {
                ...
                }, this)).on("mousemove.jstree", $.proxy(function(e) {
                    if ($.vakata.dnd.is_drag && $.vakata.dnd.user_data.jstree) {
                ...
                }, this)).on("scroll.jstree", $.proxy(function(e) {
                    if ($.vakata.dnd.is_drag && $.vakata.dnd.user_data.jstree && m && ml) {
                        m.hide();
                        ml.hide();
                    }
                }, this)).on("mousedown.jstree", "a", $.proxy(function(e) {
                    if (e.which === 1) {
                        this.start_drag(e.currentTarget, e);
                        return false;
                    }
                }, this)).on("mouseenter.jstree", "a", $.proxy(function(e) {
                    if ($.vakata.dnd.is_drag && $.vakata.dnd.user_data.jstree) {
                        this.dnd_enter(e.currentTarget);
                    }
                }, this)).on("mousemove.jstree", "a", $.proxy(function(e) {
                    if ($.vakata.dnd.is_drag && $.vakata.dnd.user_data.jstree) {
                ...
                }, this)).on("mouseleave.jstree", "a", $.proxy(function(e) {
                    if ($.vakata.dnd.is_drag && $.vakata.dnd.user_data.jstree) {
                        if (e.relatedTarget && e.relatedTarget.id && e.relatedTarget.id === "jstree-marker-line") {
                            return false;
                        }
                ...
                }, this)).on("mouseup.jstree", "a", $.proxy(function(e) {
                    if ($.vakata.dnd.is_drag && $.vakata.dnd.user_data.jstree) {
                        this.dnd_finish(e);
                    }
                }, this));
                $(document).on("drag_stop.vakata", $.proxy(function() {
                    if (this.data.dnd.to1) {
                        clearTimeout(this.data.dnd.to1);
                    }
                    if (this.data.dnd.to2) {
                ...
                }, this)).on("drag_start.vakata", $.proxy(function(e, data) {
                    if (data.data.jstree) {
                ...
                if (s.drag_target) {
                    $(document).on("mousedown.jstree-" + this.get_index(), s.drag_target, $.proxy(function(e) {
                        o = e.target;
                ...
                if (s.drop_target) {
                    $(document).on( "mouseenter.jstree-" + this.get_index(), s.drop_target, $.proxy(function(e) {
                    ...
                    }, this)).on("mouseleave.jstree-" + this.get_index(), s.drop_target, $.proxy(function(e) {
                        if (this.data.dnd.active) {
                            $.vakata.dnd.helper.children("ins").attr("class", "jstree-invalid");
                        }
                    }, this)).on("mouseup.jstree-" + this.get_index(), s.drop_target, $.proxy(function(e) {
        ...
        $(function() {
            ...
            m = $("<div />").attr({
                id: "jstree-marker"
            }).hide().html("&raquo;").on("mouseleave mouseenter", function(e) {
                m.hide();
                ml.hide();
                e.preventDefault();
    ...
    (function($) {
        $.jstree.plugin("checkbox", {
            __init: function() {
                ...
                this.get_container().on("open_node.jstree create_node.jstree clean_node.jstree refresh.jstree", $.proxy(function(e, data) {
                    this._prepare_checkboxes(data.rslt.obj);
                }, this)).on("loaded.jstree", $.proxy(function(e) {
                    this._prepare_checkboxes();
                }, this)).on("click.jstree",(this.data.ui && this.data.checkbox.noui ? "a" : "ins.jstree-checkbox"), $.proxy(function(e) {
                    e.preventDefault();
        ...
        $.jstree.plugin("search", {
            __init: function() {
                ...
                if (this._get_settings().search.show_only_matches) {
                    this.get_container().on("search.jstree", function(e, data) {
    ...
    (function($) {
        $.vakata.context = {
            ...
            show: function(s, t, x, y, d, p, rtl) {
                ...
                $.vakata.context.cnt.css({
                    "left": x,
                    "top": y
                }).find("li:has(ul)").on("mouseenter", function(e) {
        ...
        $(function() {
            ...
            $.vakata.context.cnt.on("click", "a", function(e) {
                e.preventDefault();
        ...
        $.jstree.plugin("contextmenu", {
            __init: function() {
                this.get_container().on("contextmenu.jstree", "a", $.proxy(function(e) {
                    e.preventDefault();
                    if (!$(e.currentTarget).hasClass("jstree-loading")) {
                        this.show_contextmenu(e.currentTarget, e.pageX, e.pageY);
                    }
                }, this)).on("click.jstree", "a", $.proxy(function(e) {
                    if (this.data.contextmenu) {
                        $.vakata.context.hide();
                    }
                }, this)).on("destroy.jstree", $.proxy(function() {
                    if (this.data.contextmenu) {
                        $.vakata.context.hide();
                    }
                }, this));
    ...
    (function($) {
        $.jstree.plugin("types", {
            __init: function() {
                ...
                }, this)).on("before.jstree", $.proxy(function(e, data) {
                    var s, t, o = this._get_settings().types.use_data ? this._get_node(data.args[0]) : false,
                ...
                if (is_ie6) {
                    this.get_container().on("load_node.jstree set_type.jstree", $.proxy(function(e, data) {
    ...
    (function($) {
        $.jstree.plugin("themeroller", {
            __init: function() {
                ...
                this.get_container().addClass("ui-widget-content").addClass("jstree-themeroller").on("mouseenter.jstree", "a", function(e) {
                    if (!$(e.currentTarget).hasClass("jstree-loading")) {
                ...
                }, this)).on("open_node.jstree create_node.jstree", $.proxy(function(e, data) {
                    this._themeroller(data.rslt.obj);
                }, this)).on("loaded.jstree refresh.jstree", $.proxy(function(e) {
                    this._themeroller();
                }, this)).on("close_node.jstree", $.proxy(function(e, data) {
                    this._themeroller(data.rslt.obj);
                }, this)).on("delete_node.jstree", $.proxy(function(e, data) {
                    this._themeroller(data.rslt.parent);
                }, this)).on("correct_state.jstree", $.proxy(function(e, data) {
    ...
    (function($) {
        $.jstree.plugin("unique", {
            __init: function() {
                this.get_container().on("before.jstree", $.proxy(function(e, data) {
                    var nms = [],
                        res = true,
                        p, t;
    ...
    (function($) {
        $.jstree.plugin("wholerow", {
            __init: function() {
                ...
                this.get_container().on("init.jstree", $.proxy(function(e, data) {
                    this._get_settings().core.animation = 0;
                }, this)).on("open_node.jstree create_node.jstree clean_node.jstree loaded.jstree", $.proxy(function(e, data) {
                    this._prepare_wholerow_span(data && data.rslt && data.rslt.obj ? data.rslt.obj : -1);
                }, this)).on("search.jstree clear_search.jstree reopen.jstree after_open.jstree after_close.jstree create_node.jstree delete_node.jstree clean_node.jstree", $.proxy(function(e, data) {
                    if (this.data.to) {
                ...
                }, this)).on("select_node.jstree deselect_node.jstree ", $.proxy(function(e, data) {
                ...
                }, this)).on("click.jstree", ".jstree-wholerow-span, ins.jstree-icon, li", function(e) {
                    ...
                    return false;
                }, this)).on("mouseleave.jstree", "li", $.proxy(function(e) {
