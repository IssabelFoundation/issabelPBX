    ...
    DateRangePicker.prototype = {
        ...
        updateView: function() {
            if (this.timePicker) {
                ...
                if (!this.endDate) {
                    this.container.find('.right .calendar-time select').attr('disabled', true).addClass('disabled');
                } else {
                    this.container.find('.right .calendar-time select').attr('disabled',false).removeClass('disabled');
                }
            }
            if (this.endDate) {
        ...
        renderCalendar: function(side) {
            ...
            var ltr = this.locale.direction == 'ltr';

            var html = '<table class="table is-narrow notfixed">';
            html += '<thead>';
            html += '<tr>';
        ...
        updateFormInputs: function() {
            ...
            if (this.singleDatePicker || (this.endDate && (this.startDate.isBefore(this.endDate) || this.startDate.isSame(this.endDate)))) {
                this.container.find('button.applyBtn').attr('disabled',false);
            } else {
                this.container.find('button.applyBtn').attr('disabled', true);
            }
