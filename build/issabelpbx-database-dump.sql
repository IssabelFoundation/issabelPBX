...
INSERT INTO `customcontexts_includes_list` VALUES ('from-internal','from-internal-additional','ENTIRE Basic Internal Dialplan',0,0),('from-internal','from-internal-custom','Custom Internal Dialplan',0,0),('from-internal','parkedcalls','Call Parking',0,0),('from-internal-additional','app-fax','app fax',0,2),('from-internal-additional','app-cf-toggle','Call Forward toggle',0,32),('from-internal-additional','app-cf-unavailable-prompt-on','CF Unavailable On',0,31),('from-internal-additional','app-cf-unavailable-on','Call Forward Unavailable On',0,30),('from-internal-additional','app-cf-unavailable-off','Call Forward Unavailable Off',0,29),('from-internal-additional','app-cf-prompting-on','CF prompt On',0,28),('from-internal-additional','app-cf-on','Call Forward On',0,27),('from-internal-additional','app-cf-off-any','CF any Off',0,26),('from-internal-additional','app-cf-off','Call Forward Off',0,25),('from-internal-additional','app-cf-busy-prompting-on','CF Busy prompt On',0,24),('from-internal-additional','app-cf-busy-on','Call Forward Busy On',0,23),('from-internal-additional','app-cf-busy-off-any','CF Busy any Off',0,22),('from-internal-additional','app-cf-busy-off','Call Forward Busy Off',0,21),('from-internal-additional','app-vmmain','Voicemail Main',0,7),('from-internal-additional','app-dialvm','Dial VM',0,6),('from-internal-additional','app-gabcast','app gabcast',0,38),('from-internal-additional','app-callwaiting-cwon','Call Waiting On',0,20),('from-internal-additional','app-callwaiting-cwoff','Call Waiting Off',0,19),('from-internal-additional','app-dictate-send','app dictate send',0,41),('from-internal-additional','app-dictate-record','app dictate record',0,40),('from-internal-additional','grps','grps',0,34),('from-internal-additional','ext-group','Ring Groups',0,33),('from-internal-additional','vmblast-grp','Voicemail Blast',0,5),('from-internal-additional','fmgrps','fmgrps',0,37),('from-internal-additional','ext-findmefollow','Follow Me',0,36),('from-internal-additional','app-fmf-toggle','Follow Me toggle',0,35),('from-internal-additional','ext-queues','Queues',0,17),('from-internal-additional','app-pbdirectory','app pbdirectory',0,13),('from-internal-additional','app-dnd-toggle','DND Toggle',0,16),('from-internal-additional','app-dnd-on','DND On',0,15),('from-internal-additional','app-dnd-off','DND Off',0,14),('from-internal-additional','app-blacklist','app blacklist',0,18),('from-internal-additional','app-recordings','app recordings',0,39),('from-internal-additional','app-speakingclock','app speakingclock',0,11),('from-internal-additional','app-speakextennum','app speakextennum',0,10),('from-internal-additional','app-echo-test','app echo test',0,9),('from-internal-additional','app-calltrace','app calltrace',0,8),('from-internal-additional','park-hints','park hints',0,4),('outbound-allroutes','outrt-1','9_outside',0,101),('from-internal-additional','ext-meetme','Conferences',0,1),('from-internal-additional','app-speeddial','app speeddial',0,12),('from-internal-additional','app-userlogonoff','app user logonoff',0,42),('from-internal-additional','ext-local-confirm','Extensions Confirm',0,43),('from-internal-additional','findmefollow-ringallv2','findmefollow ringallv2',0,44),('from-internal-additional','app-pickup','app pickup',0,45),('from-internal-additional','app-zapbarge','app zapbarge',0,46),('from-internal-additional','app-chanspy','app chanspy',0,47),('from-internal-additional','ext-test','ext-test',0,48),('from-internal-additional','ext-local','Extensions',0,49),('from-internal-additional','outbound-allroutes','ALL OUTBOUND ROUTES',0,50),('from-internal-additional','ext-injections','ext-injections',0,3);
